...
#SBATCH --job-name="MathLM-Curriculum-S2"
#SBATCH --output=logs/train_curriculum_s2_%j.txt
#SBATCH --error=logs/train_curriculum_s2_%j.err
...
echo "Starting MathLM Curriculum Training (Stages 2-4) at $(date)"

DATA_DIR=${DATA_DIR:-"$PWD/data"}
OUTPUT_ROOT=${OUTPUT_ROOT:-"$PWD/experiments"}
RUN_ID=${RUN_ID:-"curriculum_s2_${SLURM_JOB_ID}"}
